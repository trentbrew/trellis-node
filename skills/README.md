...
`npx skills` downloads the `SKILL.md` instruction sets from this repository and automatically installs them into your active coding agent's configuration directory (such as `.claude/skills/` or `.windsurf/skills/`). 
